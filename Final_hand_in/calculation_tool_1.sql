...
CREATE TABLE IF NOT EXISTS `calculation_tool_1`.`project` (
  ...
  `Project_Name` VARCHAR(45) NOT NULL, -- The project name
  `Start_Date` DATE NOT NULL, -- The project start date
  `End_Date` DATE NOT NULL, -- The project end date
  `Company_Id` INT NULL DEFAULT NULL, -- Is the foreign key from the company table, and shows which project the company has
  PRIMARY KEY (`Project_Id`), -- The tables primary key
...
CREATE TABLE IF NOT EXISTS `calculation_tool_1`.`task` (
  ...
  `End_Date` DATE DEFAULT NULL, -- The task end date
