...
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(4, 3, 'supervise the beginning of project', '2021-10-17',  '2021-10-19', 5, 'boring');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(5, 4, 'create the systems architecture', '2021-10-17',  '2021-10-18', 12, 'difficult');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(4, 5, 'Write requirements and user stories',  '2021-10-18',  '2021-10-22', 9, 'important');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(5, 6, 'create UI',  '2021-10-18',  '2021-10-25', 8, 'mockups only');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(5, 7, 'create prototype',  '2021-10-18',  '2021-10-28', 20, 'prototype only');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(6, 4, 'create prototype backend structure',  '2021-10-11',  '2021-10-13', 20, 'prototype only');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(6, 4, 'create prototype backend functionality',  '2021-10-14',  '2021-10-17', 30, 'prototype only'); -- 28
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`)  VALUES(7, 13, 'Gather requirements',  '2021-10-15',  '2021-10-18', 8, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(10, 14, 'Build system architecture',  '2021-10-19',  '2021-10-22', 30, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`)  VALUES(8, 12, 'Build backend connection', '2021-10-25',  '2021-11-01', 60, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`)  VALUES(8, 11, 'Build backend database',  '2021-10-25',  '2021-11-01',  60, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(8, 16, 'Create mockups for UI', '2021-10-25',  '2021-10-29', 20, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`)  VALUES(8, 15, 'Build frontend connection',  '2021-11-01',  '2021-11-04', 20, '');
INSERT INTO task(`Sub_Project_Id`, `User_Id`, `Task_Name`,  `Start_Date`,`End_Date`,`Work_Hours_Estimated`, `Comment`) VALUES(8, 15, 'Build frontend UI', '2021-10-29',  '2021-11-05', 40, '');
